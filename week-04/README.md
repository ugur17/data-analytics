# Jim Beam Market Analysis – Iowa Liquor Sales
...
The dataset consists of transactional liquor sales and includes:
...
All analysis is performed using SQL and visualized in Excel.
...
Jim Beam ranks **4th among vendors**, making it a strong but not dominant player.
...
### 3. Transaction-Driven Performance

The most critical finding:

> Revenue changes are primarily driven by transaction volume, not pricing.

A sharp drop in transactions leads directly to revenue decline.

---

### 4. Seasonal Volatility

- Peak performance: **March–May**
- Major decline: **Summer months**
- Severe anomaly: **December**

This suggests strong seasonality and possible operational or data issues.

---

### 5. Market Share Behavior
...
- Gap compared to market leaders
...
- Potential operational/data inconsistencies (e.g., December drop)
...
- Excel (pivot tables and visualization)
